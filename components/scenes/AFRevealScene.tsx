...
export function AFRevealScene({ compact }: { compact: boolean }) {
  ...
  useGSAP(() => {
    console.log("[Arima Animation] AFRevealScene timeline effect", { compact, refsReady: Boolean(root.current) });
    ...
    console.log("[Arima Animation] AFRevealScene timeline created");

...
export function LightTransitionScene() {
  ...
  useGSAP(() => {
    console.log("[Arima Animation] LightTransitionScene timeline effect", { refsReady: Boolean(root.current) });
    ...
    console.log("[Arima Animation] LightTransitionScene timelines created");
  }, { scope: root });
